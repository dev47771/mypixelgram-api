...
export class PublicPostController {
  ...
  async getLastPosts() {
    const files = [
      { url: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb', fileId: 'file-101' },
      { url: 'https://images.unsplash.com/photo-1465101046530-73398c7f28ca', fileId: 'file-102' },
      { url: 'https://images.unsplash.com/photo-1519125323398-675f0ddb6308', fileId: 'file-103' },
      { url: 'https://images.unsplash.com/photo-1444065381814-865dc9da92c0', fileId: 'file-104' },
    ];
